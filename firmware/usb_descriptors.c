...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x04D8,                 // Vendor ID
    0x000f,                 // Product ID: Mouse in a circle fw demo
...
ROM BYTE configDescriptor1[]={
    ...
    115,0x00,//sizeof(hid_rpt01),      // Size of the report descriptor
...
{'H','a','r','d','l','y',' ','S','o','f','t','w','a','r','e'}};

//Product string descriptor
// To protect it's identity we'll just make the user think this is a 
// system device of some sort
