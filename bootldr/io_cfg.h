...
/** U S B ***********************************************************/
#define tris_usb_bus_sense  TRISAbits.TRISA3    // Input

#if defined(USE_USB_BUS_SENSE_IO)
#define usb_bus_sense       PORTAbits.RA3
#else
...
/** L E D ***********************************************************/
#define mInitAllLEDs()      LATA &= 0xFD; TRISA &= 0xFD;
...
/** S W I T C H *****************************************************/
#define mInitAllSwitches()  TRISAbits.TRISA0 = INPUT_PIN;
