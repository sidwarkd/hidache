...
{   
    ...
    {         
        ...
        [ DllImport( "kernel32.dll", SetLastError=true ) ]
        internal static extern Boolean ReadFile( SafeFileHandle hFile, Byte[] lpBuffer, Int32 nNumberOfBytesToRead, ref Int32 lpNumberOfBytesRead, ref NativeOverlapped lpOverlapped );        
