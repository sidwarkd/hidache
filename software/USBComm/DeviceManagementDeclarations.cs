...
{    
    public partial class DeviceManagement  
    {
		...
		//    internal Int32 dbcc_devicetype; 
		//    internal Int32 dbcc_reserved; 
		//    [ MarshalAs( UnmanagedType.ByValArray, ArraySubType=UnmanagedType.U1, SizeConst=16 ) ]internal Byte[] dbcc_classguid; 
		...
		//    internal Int32 dbch_devicetype; 
		//    internal Int32 dbch_reserved; 
		//    internal Int32 dbch_handle; 
		//    internal Int32 dbch_hdevnotify; 
		//}      
		...
		//[ DllImport( "setupapi.dll", SetLastError=true ) ]
		//internal static extern Boolean SetupDiEnumDeviceInterfaces( IntPtr DeviceInfoSet, Int32 DeviceInfoData, ref System.Guid InterfaceClassGuid, Int32 MemberIndex, ref SP_DEVICE_INTERFACE_DATA DeviceInterfaceData );        
